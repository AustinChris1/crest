...
<div class="container-fluid pt-5">
    ...
    <div class="row px-xl-5 pb-3">
        ...
        foreach ($category as $categoryItems) {
            $cat_id = $categoryItems['id'];
            $st = $db->query("SELECT * FROM stock WHERE category_id = '$cat_id' AND status = '0'");
            $am = $st->num_rows;
        ?>
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                <a class="text-decoration-none" href="/crest/shop/<?= $categoryItems['url'] ?>">
                    <div class="cat-item d-flex align-items-center mb-4">
                        <div class="overflow-hidden" style="width: 100px; height: 100px;">
                            <img class="img-fluid" src="uploads/category/<?= $categoryItems['image'] ?>" alt="">
                        </div>
                        <div class="flex-fill pl-3">
                            <h6><?= $categoryItems['name'] ?></h6>
                            <small class="text-body"><?= $am?> Products</small>
                        </div>
                    </div>
                </a>
            </div>
        ...
        <div class="col">
            <div class="owl-carousel vendor-carousel">
                <div class="bg-light p-4">
                    <img src="https://spectrawebx.xyz/assets/specweblogo.png" alt="">
                </div>
                <div class="bg-light p-4">
